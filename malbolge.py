...
def initialize(source, mem):
    ...
    for c in source:
        ...
        if i == POW10:
            raise Exception('Source file is too long')
...
def interpret(mem):
    ...
    while 1:
        ...
        if v == 4:                        # jmp [d]
            ...
            # a = ord(read(1))
            raise Exception("Read is not implement yet")
